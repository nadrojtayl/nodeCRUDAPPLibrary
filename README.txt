...
2. Finish server side scripting to insert script tags for DB endpoints

4. Deal with foreign keys

5. Change API connection to take parameters for end of HTML string as obj

6. Split off code that identifies IP address into its own module and make sure it finds public ip not just ip on network